                    ...
                    <div className="about-wrapper">
                        <div className="about-content">
                            ...
                            <div className="about-desc">                            
                                <div>                   
                                    <p>Hi, my name is Darrien - a front-end web developer based in British Columbia. I'm a passionate and ambitious developer who specializes in creating clean and mobile responsive websites.                                    
                                    <br />
                                    <br />
